...
may change a v1 path and schema while preserving semantic status and provenance; that is not an ordinary reopen.
...
| LIF-01-020 | A controlled, ledgered migration MAY change a v1 representation while preserving ID, status meaning, authority, and evidence. |
