...
| `harness-data/guides/` | Optional — add stack-specific setup guides |
| `harness-data/{legacy,use-cases,specs,tasks,implementation-plans,reviews,improvements,transcripts,ideas}/` | Project-specific — generated by using the harness |
