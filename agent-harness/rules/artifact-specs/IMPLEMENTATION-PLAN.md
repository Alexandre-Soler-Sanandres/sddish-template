...
| IPL-05-083 | Cascade | Status transitions this Plan participates in (completion cascade, upward approval cascade) are governed by `systems/STATUS-TRANSITIONS.md`, not defined here. |
