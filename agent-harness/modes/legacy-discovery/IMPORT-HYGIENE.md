...
| LD-07-040 | Import-Hygiene | Before committing an imported snapshot or import-hygiene change, verify nested Git metadata: `find harness-data/artifacts/legacy/imported/<app-slug> -path '*/.git' -type d` — expected result is no output. Surface any hit to the user before proceeding. |
