...
| 6 | Domain ownership and workflow boundary synthesis | pending | `findings/` entries, `QUESTIONS.md`, candidate Use Cases/Specs as needed | Confirm which app owns canonical outcomes versus presentation, orchestration, or adapter behavior. |
